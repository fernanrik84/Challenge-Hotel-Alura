...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(82, 60, 259, 42);
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
	                ...
	                try{
	                    ...
	                    JOptionPane.showMessageDialog(new JFrame(),"Ha ocurrido un error");
	                    return;
	                }
		...
		lblSiguiente_1.setForeground(new Color(0, 0, 0));
		lblSiguiente_1.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblSiguiente_1.setBounds(23, 0, 75, 35);
