...
public class MenuPerfil extends JFrame{
    ...
    private sesionController sessionControler;

    public MenuPerfil(userModel usuario) {
...
;
            ...
            txtNombre.addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    if (txtUsuario.getText().isEmpty()) {
                        txtUsuario.setText(usuario.getPassword());
                        txtUsuario.setForeground(Color.black);
                    }

                    if (txtNombre.getText().equals(usuario.getNombre())) {
                        txtNombre.setText("");
            ...
            txtApellido.addMouseListener(new MouseAdapter() {
                @Override
                public void mousePressed(MouseEvent e) {
                    if (txtApellido.getText().equals(usuario.getApellido())) {
                        txtApellido.setText("");
                        txtApellido.setForeground(Color.black);
                    }
            ...
            txtUsuario.addMouseListener(new MouseAdapter() {
                @Override
                public void mousePressed(MouseEvent e) {
                    if (txtUsuario.getText().equals(usuario.getUsuario())) {
                        txtUsuario.setText("");
                        txtUsuario.setForeground(Color.black);
                    }
                    if (String.valueOf(txtContrasena.getPassword()).isEmpty()) {
            ...
            JLabel labelTitulo = new JLabel("Tus datos");
        ...
        btnEliminar.addMouseListener(new MouseAdapter() {
            ...
            btnEliminar.setBackground(SystemColor.textHighlight);
            btnEliminar.setBounds(209, 471, 122, 44);
            ...
            lblEliminar.setForeground(SystemColor.controlLtHighlight);
    ...
    private void delete() {
        Long id = this.usuario.getIdusers();
        sessionControler = new sesionController();
        sessionControler.eliminarSesion();
        login.eliminar(id);
    ...
    private void update() {
            ...
            if((usuario.equals("Ingrese su nombre de usuario") || nombre.equals("Ingrese su nombre") || apellido.equals("Ingrese su apellido")) ||
                            (usuario.isEmpty()  || nombre.isEmpty() || apellido.isEmpty())){
                JOptionPane.showMessageDialog(this, "por favor rellene todos los campos");
            } else {
                if(contrase.equals("") || contrase.equals("******")){
                    newPass = this.usuario.getPassword();
                }
                newPass = ValidatePasswords.encryptPassword(contrase);
                userModel usuario1 = new userModel(
                        nombre,apellido,usuario,newPass
                );
                usuario1.setIdusers(this.usuario.getIdusers());
                login.actualizar(usuario1);
