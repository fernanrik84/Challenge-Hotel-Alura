...
import com.alura.hotel.hotelAlura.utils.ConvertDates;
...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				// aqio va codigo para ventana despues de registrar huesped
                ...
                if(txtFechaN.getDate() != null) {
                    date =  Date.valueOf(ConvertDates.convertDateToLocalDate(txtFechaN.getDate()));
                }
                if(nombre.length() == 0 || apellido.length() == 0 || nacionalidad.length() == 0 || telefono.length() == 0 ){
                    JOptionPane.showMessageDialog(new JFrame(), "rellene todos los campos" );
                    return;
                }
                if(Objects.equals(nombre, "Fercho")){
                    JOptionPane.showMessageDialog(new JFrame(), "Tranquilo pa, todo free para tí!!" );
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "el número de telefono no debe contener letras" );
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "no se puede guardar el huesped, intente de nuevo!!" );
                    return;
                }
